...
export class AuthFirebaseService {
  ...
  errorMessage(msg: string){
    const defaultMessage: string = msg;
    const errorMessage: any = {
      ...
      'auth/invalid-phone-number'           : 'The provided value for the phoneNumber is invalid.',
      ...
      'auth/reserved-claims'                : 'One or more custom user claims provided to setCustomUserClaims() are reserved.',
    ...
    return errorMessage[msg] || defaultMessage;
  }
}
